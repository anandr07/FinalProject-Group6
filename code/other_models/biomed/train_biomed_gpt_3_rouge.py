        ...
        for epoch in range(num_epochs):
            ...
            for batch_idx, batch in enumerate(progress_bar):
                try:
                    ...
                    # Combined loss
                    total_loss = gen_loss * 0.7 + clip_loss_value * 0.3
                    ...
                    try:
                        ...
                        if len(val_predictions) < 100:
                            try:
                                ...
                                logger.error(f"Error generating validation reports: {str(e)}")
                                continue
            ...
            if val_predictions and val_targets:
                ...
                for pred, target in zip(val_predictions, val_targets):
                    if pred and target:  # Check for non-empty strings
                        try:
                            score = rouge_scorer_obj.score(pred, target)['rougeL'].fmeasure
